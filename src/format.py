...
fileReadObj = open('../test_sample/codeE7.c')
fileBeforeFormater = []
match1_1_list = []
match1_2_list = []
match2_list = []
...
fileWriteObj = open("../output/tmp.c", 'w')
...
fileWriteObj = open("../output/output.c", 'w')
for i in fileBeforeFormater:
    fileWriteObj.write(i)
fileWriteObj.close()
...
fileWriteObj = open("../output/outputInfo.txt", 'w')
for i in outputList:
    fileWriteObj.write(i)
fileWriteObj.close()